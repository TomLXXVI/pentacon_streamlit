...
st.header("Tijdsgrafiek logger 12")
st.subheader("Hal 7, ruimtetemperatuur")
st.plotly_chart(pmd.get_line_chart(Logger.HALL_7, Measurement.TEMPERATURE), use_container_width=True)
