...
st.header("Tijdsgrafiek logger 1")
st.subheader("Hal 10, onder lichtstraat, bovenaan/rechts")
st.markdown("rechts = kant pulsie | links = kant extractie")
st.plotly_chart(pmd.get_line_chart(Logger.TOP_RIGHT, Measurement.TEMPERATURE), use_container_width=True)
