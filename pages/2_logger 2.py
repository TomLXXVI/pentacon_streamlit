...
st.header("Tijdsgrafiek logger 2")
st.subheader("Hal 10, onder lichtstraat, midden/rechts")
st.markdown("rechts = kant pulsie | links = kant extractie")
st.plotly_chart(pmd.get_line_chart(Logger.MIDDLE_RIGHT, Measurement.TEMPERATURE), use_container_width=True)
