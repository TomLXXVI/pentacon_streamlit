...
st.header("Tijdsgrafiek logger 3")
st.subheader("Hal 10, onder lichtstraat, onderaan/rechts")
st.markdown("rechts = kant pulsie | links = kant extractie")
st.plotly_chart(pmd.get_line_chart(Logger.BOTTOM_RIGHT, Measurement.TEMPERATURE), use_container_width=True)
