...
st.header("Tijdsgrafiek logger 4")
st.subheader("Hal 10, onder lichtstraat, bovenaan/midden")
st.markdown("rechts = kant pulsie | links = kant extractie")
st.plotly_chart(pmd.get_line_chart(Logger.TOP_MIDDLE, Measurement.TEMPERATURE), use_container_width=True)
