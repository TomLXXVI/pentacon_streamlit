...
st.header("Tijdsgrafiek logger 6")
st.subheader("Hal 10, onder lichtstraat, onderaan/midden")
st.markdown("rechts = kant pulsie | links = kant extractie")
st.plotly_chart(pmd.get_line_chart(Logger.BOTTOM_MIDDLE, Measurement.TEMPERATURE), use_container_width=True)
