...
st.header("Tijdsgrafiek logger 7")
st.subheader("Hal 10, onder lichtstraat, bovenaan/links")
st.markdown("rechts = kant pulsie | links = kant extractie")
st.plotly_chart(pmd.get_line_chart(Logger.TOP_LEFT, Measurement.TEMPERATURE), use_container_width=True)
