...
st.header("Tijdsgrafiek logger 8")
st.subheader("Hal 10, onder lichtstraat, midden/links")
st.markdown("rechts = kant pulsie | links = kant extractie")
st.plotly_chart(pmd.get_line_chart(Logger.MIDDLE_LEFT, Measurement.TEMPERATURE), use_container_width=True)
