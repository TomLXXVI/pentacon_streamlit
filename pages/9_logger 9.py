...
st.header("Tijdsgrafiek logger 9")
st.subheader("Hal 10, onder lichtstraat, onderaan/links")
st.markdown("rechts = kant pulsie | links = kant extractie")
st.plotly_chart(pmd.get_line_chart(Logger.BOTTOM_LEFT, Measurement.TEMPERATURE), use_container_width=True)
